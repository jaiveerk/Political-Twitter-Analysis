...
Meanwhile, non-left respondents liked right-aligned tweets almost exactly as frequently as they liked left-aligned tweets. This may be due to the fact that centrists make up a significant portion of the non-left population, but even then, the fact that the conservative portion of the non-left respondents didn't create any sort of separation between the two categories of tweets is intriguing to say the last. This is made even more surprising upon observing that a similar trend holds for other kinds of engagement, including profile clicks, likes, retweets, and writing replies. 

There also wasn't much separation between the frequencies at which non-left respondents ignored left-aligned and right-aligned tweets, and the same seems to hold true for retweets and ignoring tweets. As was the case with the left-identifying respondents, though, non-left respondents marked "view replies" at about the same frequency for both categories of tweets. 
